...
import { Menu, X, Users, LogOut, Home, Layout, FileText, Settings, SquareMenu } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="text-center p-4">
          ...
          <Link href="/admin/login" className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">
            Login
          </Link>
        </div>
      </div>
