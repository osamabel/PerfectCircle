      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl  mb-4">
            {t("weTalk")} <span className="gradient-text">{t("hope")}</span>{" "}
            {t("helping")}
            <br />
          ...
          <div className="relative">
            ...
            {teamMembers.length > slidesToShow && (
              <>
                <button
                  onClick={prevSlide}
                  className="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 bg-[#65DBA8] border-[1px] border-[#3c3c3c] hover:bg-transparent hover:border-[#73e896]/40 hover:text-[#65DBA8] text-black w-10 h-10 rounded-full flex items-center justify-center -ml-5 focus:outline-none transition-all duration-300"
                ...
                <button
                  onClick={nextSlide}
                  className="absolute right-0 top-1/2 transform -translate-y-1/2 z-10 bg-[#65DBA8] border-[1px] border-[#3c3c3c] hover:bg-transparent hover:border-[#73e896]/40 hover:text-[#65DBA8] text-black w-10 h-10 rounded-full flex items-center justify-center -mr-5 focus:outline-none transition-all duration-300"
                  ...
                  >
                    ...
                    <div className="aspect-square w-full">
                      <div className="relative h-full w-full">
                        ...
                        <div
                          className={`absolute right-4 top-4 flex flex-col space-y-2 transition-opacity bg-white p-2 rounded-full duration-300 ${
                        ...
                        >
                          {member.social_links?.facebook && (
                            <a
                              ...
                              className="bg-[#65DBA8] border-[1px] border-[#3c3c3c] text-black p-2 rounded-full hover:bg-transparent hover:border-[#73e896]/40 hover:text-[#65DBA8] transition-all duration-300"
                              aria-label="Facebook"
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
            ...
            {teamMembers.length > slidesToShow && (
              <div className="flex justify-center mt-8 space-x-2">
                {Array.from({
                  length: Math.ceil(teamMembers.length / slidesToShow),
                }).map((_, index) => {
